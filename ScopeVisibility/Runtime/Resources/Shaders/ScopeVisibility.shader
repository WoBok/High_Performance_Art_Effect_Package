Shader "URP Shader/Scope Visibility" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma multi_compile_fragment  _ _VISIBILITY_SQUARE _VISIBILITY_CIRCLE
            ...
            #include "ScopeVisibilityInput.hlsl"
            #include "ScopeVisibilityForwardPass.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.ScopeVisibilityShader"
}