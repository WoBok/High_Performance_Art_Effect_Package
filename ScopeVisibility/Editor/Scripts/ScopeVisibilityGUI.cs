...
{
    public static class ScopeVisibilityGUI
    {
        ...
        public struct AllInOneProperties
        {
            ...
            public AllInOneProperties(MaterialProperty[] properties)
            {
        ...
        public static void Inputs(AllInOneProperties properties, MaterialEditor materialEditor, Material material)
        {
            DoSpecularArea(properties, materialEditor, material);
            BaseShaderGUI.DrawNormalArea(materialEditor, properties.bumpMapProp);
        }
        public static void Advanced(AllInOneProperties properties)
        {
        ...
        public static void DoSpecularArea(AllInOneProperties properties, MaterialEditor materialEditor, Material material)
        {
        ...
        static void UpdateMaterialSpecularSource(Material material)
        {
