...
{
    internal class ScopeVisibilityShader : BaseShaderGUI
    {
        ...
        ScopeVisibilityGUI.AllInOneProperties shadingModelProperties;
        public override void FindProperties(MaterialProperty[] properties)
        {
            base.FindProperties(properties);
            shadingModelProperties = new ScopeVisibilityGUI.AllInOneProperties(properties);
        }
        public override void ValidateMaterial(Material material)
        {
            SetMaterialKeywords(material, ScopeVisibilityGUI.SetMaterialKeywords);
        }
        ...
        public override void DrawSurfaceInputs(Material material)
        {
            ...
            ScopeVisibilityGUI.Inputs(shadingModelProperties, materialEditor, material);
        ...
        {
            ScopeVisibilityGUI.Advanced(shadingModelProperties);
